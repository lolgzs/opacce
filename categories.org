...
**** TODO réservation auto. pas activée et aucune réservation pour l'utilisateur
**** TODO c'est pas l'utilisateur qui a réservé (réservation en cours)
**** DONE poste/device non trouvé (DeviceNotFound)
		 CLOSED: [2012-08-10 Fri 11:28]
