...
$lang['UPLOAD_IMAGES_ONLY']					=	'Seules des images peuvent être transférées (.jpg, .jpeg, .gif, .png).';
$lang['UPLOAD_SWF_ONLY']					=	'Seuls des objets Flash peuvent être transférés (.swf).';
...
$lang['UPLOAD_FILE_ONLY_TYPE']				=	'Seuls les types de fichiers suivants peuvent être transférés: %s';
