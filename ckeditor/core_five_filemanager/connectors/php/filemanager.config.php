 ...
 *	Upload settings
 */
$config['upload']['overwrite'] = true; // true or false; Check if filename exists. If false, index will be added
$config['upload']['size'] = 1.5; // integer or false; maximum file size in Mb; please note that every server has got a maximum file upload size as well.
$config['upload']['imagesonly'] = false; // true or false; Only allow images (jpg, gif & png) upload?
$config['upload']['images']['size'] = 0.15; //Maximum file size for images
$config['upload']['flash']['size'] = 0.15; //Maximum file size for images

/**
 *	Images array
 *	used to display image thumbnails
 */
$config['images'] = array('jpg', 'jpeg','gif','png', 'ico');
