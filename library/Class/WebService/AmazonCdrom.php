 ...
 */
/*
 * WEB SERVICE AMAZON POUR LES CDROMS
 */

class Class_WebService_AmazonCdrom extends Class_WebService_Amazon
{
	
	function rend_notice_ean($ean)
	{
		$req=$this->req_ean_video($ean)."&ResponseGroup=Large";
		if($req == "") return false;
	...
	function req_ean_video($ean)
	{
		...
		$url="&Operation=ItemSearch&SearchIndex=SoftwareVideoGames&Keywords=" .$ean;
		return $url;
	}
}