 ...
 */
//////////////////////////////////////////////////////////////////////////////////////////
// OPAC3 - Bloc menu, edition des profils
//////////////////////////////////////////////////////////////////////////////////////////
class ZendAfi_View_Helper_Admin_BlocMenu extends ZendAfi_View_Helper_BaseHelper {
	function blocMenu($path_ico,$id_menu,$menu,$is_sous_menu=false,$browser)
	{
		// Combo des fonctions
		...
		// Html
		if($id_menu=="menu_vide" or $id_menu=="sous_menu_vide") $display="none"; else $display="block";
		...
		if($menu["type_menu"] == "MENU") $display="block"; else $display="none";
		...
		if(array_isset('sous_menus', $menu))
			{
				foreach($menu["sous_menus"] as $sous_menu ) $html.=$this->blocMenu($path_ico,"module",$sous_menu,true,$browser);
			}
		$html.='</div>';
