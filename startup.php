...
function setupConstants($cfg) {
	defineConstant('VERSION_PERGAME','V-05.13 [r'.array_at(1, explode(' ', '$Revision$ ')).']');
	...
	defineConstant('JQUERY', URL_ADMIN_JS . 'jquery-1.6.4.min.js');
...
function setupFrontController() {
	$front_controller = Zend_Controller_Front::getInstance()
		...
		->addModuleDirectory(MODULEDIRECTORY)
					//					->addControllerDirectory('application/modules/opac/controllers','opac')
					//					->addModuleDirectory('./afi/modules')
