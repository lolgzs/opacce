...
/* Handle keystrokes. */
	...
	_connectColorPicker: function(target, inst) {
		...
		// Create sample span
		inst._sampleSpan = $('<div class="ColorPickerDivSample" style="float:left;background-color:' + inst._input[0].value + ';height:' + inst._input[0].offsetHeight + ';">&nbsp;</div>');
		input.before(inst._sampleSpan);
...
$.extend(ColorPickerInstance.prototype, {
	...
	_generateColorPicker: function() {
        ...
        var width = 18;
	    var html = "<table style='border:1px solid #bbbbbb;background-color:#ffffff;padding:2px;'; cellspacing='1' cellpadding='0'>";
		...
		//html += '<tr><td title="" style="background-color:#ffffff" class="color" colspan="' + width + '" align="center"><label>pas de couleur</label></td></tr>'
