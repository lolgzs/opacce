...
a(t).css("marginTop",-t.offsetHeight).animate({marginTop:0},c.captionAnimationDuration);m.style.visibility=""}function F(){i.onload=null;i.src=I.src=J.src=q;a([d,l,t]).stop(!0);a([r,s,l,m]).hide()}function C(){0<=g&&(F(),g=n=p=-1,a(d).hide(),a(e).stop().fadeOut(c.overlayFadeDuration,A));c.onClose();return!1}var k=a(window),c,h,g=-1,q,n,p,z,x,f,j,B=!window.XMLHttpRequest,u=[],i={},I=new Image,J=new Image,e,d,l,w,r,s,m,t,G,H;a(function(){a("body").append(a([e=a('<div id="lbOverlay" />')[0],d=a('<div id="lbCenter" />')[0],
...
g,i){c=a.extend({loop:!1,overlayOpacity:0.8,overlayFadeDuration:400,resizeDuration:400,resizeEasing:"swing",initialWidth:250,initialHeight:250,imageFadeDuration:400,captionAnimationDuration:400,counterText:"Image {x} of {y}",closeKeys:[27,88,67],previousKeys:[37,80],nextKeys:[39,78],onClose:function(){}},i);"string"==typeof b&&(b=[[b,g]],g=0);x=k.scrollTop()+k.height()/2;f=c.initialWidth;j=c.initialHeight;a(d).css({top:Math.max(0,x-j/2),width:f,height:j,marginLeft:-f/2}).show();if(z=B||e.currentStyle&&
"fixed"!=e.currentStyle.position)e.style.position="absolute";a(e).css("opacity",c.overlayOpacity).fadeIn(c.overlayFadeDuration);y();A(1);h=b;c.loop=c.loop&&1<h.length;return v(g)};a.fn.slimbox=function(b,c,d){var c=c||function(a){return[a.href,a.title]},d=d||function(){return!0},g=this;return g.unbind("click").click(function(h){h.stopImmediatePropagation();var i=this,h=0,f,e=0,j;f=a.grep(g,function(a,b){return d.call(i,a,b)});for(j=f.length;e<j;++e)f[e]==i&&(h=e),f[e]=c(f[e],e);return a.slimbox(f,
h,b)})}})(jQuery);
